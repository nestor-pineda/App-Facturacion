    ...
    <div className="page-container">
      <div className="flex items-center justify-between page-header">
        <div>
          ...
          <p className="page-subtitle">{services?.length ?? 0} servicios disponibles</p>
        </div>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-12 text-muted-foreground">
          {search ? 'No se encontraron servicios' : 'Aún no tienes servicios. Crea el primero.'}
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Servicio</th>
                <th className="text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Descripción</th>
                <th className="text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Precio base</th>
                <th className="text-right text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">IVA</th>
